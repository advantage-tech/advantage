...
export const SERVICE_MONOLITHS = [
  {
    ...
    description:
      "We engineer brand identities that resonate across every touchpoint — from visual systems and naming to narrative frameworks that position your business as a category leader.",
    capabilities: [
      "Brand Strategy",
  ...
  },
  {
    ...
    description:
      "Data-driven marketing ecosystems powered by machine learning. We deploy intelligent campaigns for media houses, hospitality brands, and FinTechs — adapting in real-time for maximum ROI.",
    capabilities: [
...
export const TEAM = [
  {
    ...
    bio: "6 years leading enterprise transformation across Africa and the Middle East. Creative director, also turned technology entrepreneur. Akubo founded Advantage with the conviction that every business deserves access to world-class digital infrastructure.",
  ...
  },
  {
    ...
    bio: "Full-stack architect with deep expertise in cloud-native systems, AI integration, and enterprise ERP. Ekong has led engineering teams at companies backed by Amazon and Google",
  ...
  },
  {
    ...
    bio: "Operations architect with a track record of scaling service businesses from 10 to 200+ people. Amara oversees all client delivery, ensuring every engagement runs on time, on budget, and above expectation.",
  ...
  },
  {
    ...
    bio: "Award-winning brand strategist who has defined the visual identities of luxury hospitality brands, GCC retail groups, and global media companies. Layla leads our branding practice.",
...
export const FAQS = [
  {
    ...
    answer:
      "We work across virtually every major industry — including hospitality, FinTech, interior design, media and broadcasting, retail, real estate, logistics, and enterprise manufacturing. Our team brings sector-specific knowledge to every engagement.",
  },
  {
    category: "Getting Started",
    question:
    ...
    answer:
      "If you're experiencing operational friction, outgrowing your current systems, preparing for a growth inflection (fundraise, market expansion, rebrand, product launch), or simply losing ground to more tech-forward competitors — you're ready.",
  },
  {
    category: "Services",
    question: "What's included in your branding service? Is it just a logo?",
    answer:
      "Not even close. Our branding engagements produce a complete Brand Intelligence System — visual identity (logo, colour, typography, iconography), brand voice and messaging frameworks, application across print and digital, motion guidelines, and a living brand document.",
  },
  {
    category: "Services",
    question:
    ...
    answer:
      "Off-the-shelf tools are built for the average business — and they make you bend your workflows to fit their software. A custom ERP is built around how you actually operate. On average, custom ERP clients save 40–60% in long-term costs compared to enterprise licensing.",
  },
  {
    category: "Services",
    question:
    ...
    answer:
      "Absolutely — this is one of our most common engagements. We take you from concept to a production-ready product. The process covers market validation, product architecture, UX design, development, infrastructure setup, and launch.",
  },
  {
    category: "Process",
    question: "How long does a typical engagement take?",
    answer:
      "Brand identity: 6–10 weeks. SaaS MVP: 12–20 weeks. Custom ERP: 16–36 weeks depending on complexity. AI marketing systems: 4–8 weeks for initial deployment. All timelines are scoped transparently in your proposal.",
  },
  {
    category: "Pricing",
    question: "How is pricing structured?",
    answer:
      "Brand and design engagements are fixed-scope, fixed-fee — no surprises. Product and ERP development is structured in milestone-based phases. We don't do open-ended retainers. Every proposal includes a detailed scope, deliverable list, and payment schedule.",
  },
  {
    category: "Pricing",
    question: "What is the minimum project size you work with?",
    answer:
      "Our minimum engagement is $15,000 USD (or equivalent local currency). For earlier-stage businesses, we offer a focused 4-week Accelerator Sprint — maximum impact, defined scope, fixed budget.",
  },
];
